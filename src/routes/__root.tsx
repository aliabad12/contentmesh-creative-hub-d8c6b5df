...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI videos, animations, voiceovers, and cinematic marketing content that grows your business." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ContentMesh — AI-Powered Creative Content Studio" },
      { name: "twitter:description", content: "AI videos, animations, voiceovers, and cinematic marketing content that grows your business." },
    ],
    links: [
